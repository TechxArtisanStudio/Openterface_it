...
export const accessorySkus: AccessorySku[] = [
  {
    ...
    description: "Accessori essenziali inclusi adattatori video, cavi ad alta velocità e soluzioni di archiviazione. Migliora la tua esperienza Openterface con attrezzature di qualità da TxA Shop.",
...
export const accessoriesProduct: Product = {
  ...
  seoDescription:
    "Accessori Openterface — cavi, adattatori, borse porta attrezzi e connettori video.",
  ...
  painPoints: [
    "La mancanza del cavo giusto sul campo ritarda ogni riparazione",
  ],
  solutions: [
    "Accessori curati e testati con i prodotti Openterface",
  ],
  hwFeatures: [
  ...
  useCases: [
    "Organizzazione kit da campo",
    "Conversione formato video",
    "Cavi di riserva per le borse IT",
  ],
  useCaseCards: [
    {
