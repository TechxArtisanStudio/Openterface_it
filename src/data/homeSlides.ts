...
export const homeSlides: HomeSlide[] = [
  {
    ...
    secondaryCta: { label: 'Vedi Prodotto', href: '/keymod/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Vedi Prodotto', href: '/kvmgo/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Vedi Prodotto', href: '/minikvm/' },
  ...
  },
  {
    ...
    secondaryCta: { label: 'Vedi Accessori', href: '/accessories/' },
